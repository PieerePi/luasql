...
#define OCI_IDU_BATCH_COMPATIBLE            0x80000000              /*DM extend mode, to compatible with oracle idu execute mode*/
#define     DCI_IDU_BATCH_COMPATIBLE            OCI_IDU_BATCH_COMPATIBLE
